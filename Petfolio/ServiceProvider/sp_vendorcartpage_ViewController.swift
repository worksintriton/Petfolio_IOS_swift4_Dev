//
//  sp_vendorcartpage_ViewController.swift
//  Petfolio
//
...
//            cell.label_final_amt.text = "₹ " + String(productdata["cost"] as? Int ?? 0)
        ...
        @objc func action_delete(sender: UIButton){
            ...
            let alert = UIAlertController(title: "Are you sure need to delete the products?", message: "", preferredStyle: .alert)
            alert.addAction(UIAlertAction(title: "Yes", style: .default, handler: { action in
    ...
    extension sp_vendorcartpage_ViewController {
