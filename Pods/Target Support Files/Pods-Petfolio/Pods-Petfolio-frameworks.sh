...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AAMaterialSpinner/AAMaterialSpinner.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SNShadowSDK/SNShadowSDK.framework"
