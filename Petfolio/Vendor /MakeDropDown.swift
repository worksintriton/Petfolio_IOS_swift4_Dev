...
class MakeDropDown: UIView{
    ...
    func setUpDropDown(viewPositionReference: CGRect,  offset: CGFloat){
        ...
        print(viewPositionReference)
        self.frame = CGRect(x: viewPositionReference.origin.x + 10, y: viewPositionReference.origin.y + 50, width: 0, height: 0)
        dropDownTableView = UITableView(frame: CGRect(x: viewPositionReference.origin.x, y: viewPositionReference.origin.y, width: 0, height: 0))
