//
//  pet_vendor_shipingaddlocationViewController.swift
//  Petfolio
//
...
class pet_vendor_shipingaddlocationViewController: UIViewController, GMSMapViewDelegate, CLLocationManagerDelegate, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        if Servicefile.shared.locaaccess == "Add" {
            ...
            Servicefile.shared.islocationget = false
        }else{
