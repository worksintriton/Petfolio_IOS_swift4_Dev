//
//  myaddress_create_address_ViewController.swift
//  Petfolio
//
...
class myaddress_create_address_ViewController: UIViewController, UITextFieldDelegate, UITextViewDelegate {
    ...
    @IBOutlet weak var textfield_doorno: UITextField!
    ...
    func getdetails(){
        ...
        self.textfield_doorno.text! = details["user_flat_no"] as? String ?? ""
...
//    }
    ...
    @IBAction func action_create_ship_address(_ sender: Any) {
        ...
        let doorno = self.textfield_doorno.text!
    ...
    func call_create_shipping_address(){
        ...
        if Servicefile.shared.updateUserInterface() { AF.request(Servicefile.pet_vendor_shiping_address_submit, method: .post, parameters:
                                                                    ["user_id":Servicefile.shared.userid,
                                                                     ...
                                                                     "user_flat_no" : self.textfield_doorno.text!,
