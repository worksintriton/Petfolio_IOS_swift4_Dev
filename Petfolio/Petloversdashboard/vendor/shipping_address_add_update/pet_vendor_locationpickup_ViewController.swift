//
//  pet_vendor_locationpickup_ViewController.swift
//  Petfolio
//
...
class pet_vendor_locationpickup_ViewController: UIViewController, GMSMapViewDelegate, CLLocationManagerDelegate, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewWillDisappear(_ animated: Bool) {
            if let firstVC = presentingViewController as? pet_vendor_shipingaddlocationViewController {
