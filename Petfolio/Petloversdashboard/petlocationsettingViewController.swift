//
//  petlocationsettingViewController.swift
//  Petfolio
//
...
class petlocationsettingViewController: UIViewController, GMSMapViewDelegate, CLLocationManagerDelegate, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource {
