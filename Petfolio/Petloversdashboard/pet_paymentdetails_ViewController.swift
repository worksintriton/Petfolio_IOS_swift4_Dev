//
//  pet_paymentdetails_ViewController.swift
//  Petfolio
//
...
class pet_paymentdetails_ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    // header action
        self.view_subpage_header.label_header_title.text = "Payment Details"
    ...
    func callservice(){
        ...
        if Servicefile.shared.updateUserInterface() { AF.request(Servicefile.pet_payment_details, method: .post, parameters:
