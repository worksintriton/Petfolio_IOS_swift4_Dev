//
//  sp_todaydeals_ViewController.swift
//  Petfolio
//
...
class sp_todaydeals_ViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UITextFieldDelegate {
    ...
    extension sp_todaydeals_ViewController {
