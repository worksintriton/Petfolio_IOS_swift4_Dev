//
//  doclocationsettingViewController.swift
//  Petfolio
//
...
class doclocationsettingViewController: UIViewController, GMSMapViewDelegate, CLLocationManagerDelegate, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource {
