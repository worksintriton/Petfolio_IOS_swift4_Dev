...
//                let attributeString: NSMutableAttributedString =  NSMutableAttributedString(string: String(Servicefile.shared.petnewprod[indexPath.row].product_offer_value) + "% off")
