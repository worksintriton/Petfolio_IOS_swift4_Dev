//
//  doc_set_new_location_ViewController.swift
//  Petfolio
//
...
class Doc_new_setlocation_ViewController: UIViewController , GMSMapViewDelegate, CLLocationManagerDelegate, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewWillDisappear(_ animated: Bool) {
            if let firstVC = presentingViewController as? regdocViewController {
                      DispatchQueue.main.async {
                       firstVC.viewWillAppear(true)
                      }
                  }
        if let firstVC = presentingViewController as? Doc_update_details_ViewController {
                  DispatchQueue.main.async {
                   firstVC.viewWillAppear(true)
                  }
              }
